...
from .models import LandingPageTheme
...
class ThemeManager:
    ...
    def install_theme(self, slug: str, force_update: bool = False) -> LandingPageTheme | None:
        ...
        Returns:
            Instância de LandingPageTheme criada/atualizada ou None em caso de erro
        """
        ...
        theme, created = LandingPageTheme.objects.update_or_create(slug=slug, defaults=defaults)
